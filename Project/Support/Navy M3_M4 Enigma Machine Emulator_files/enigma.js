...
function mapLetter(number, ringstellung, wheelposition, wheel, pass)
{
	...
	var offset = ringstellung - wheelposition;
    document.getElementById('showDebug').value += "offset: " + offset + "\n";
	...
	if (pass == 2) {
		...
		document.getElementById('showDebug').value += "true input character: " + let + "\n";
	...
	document.getElementById('showDebug').value += "true output character (number): " + ENIGMA.plaintext.charAt(number) + "\n";
	number = number - wheelposition;
	...
	number = number + ringstellung;
	document.getElementById('showDebug').value += "final output character (pre-normalized number) " + number + "\n";

		// Check number is between 1 and 26
		number = validLetter(number);
	document.getElementById('showDebug').value += "final output character (post-normalized number) " + number + "\n";
	document.getElementById('showDebug').value += "final output character (post-normalized) " + ENIGMA.plaintext.charAt(number) + "\n";
