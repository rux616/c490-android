...
public class TicTacToe {
    ...
    public enum Status {IN_PROGRESS, X_WIN, O_WIN, DRAW}
     ...
     */
    public TicTacToe(int rows, int columns, int winLength) {
    ...
    public int getSpaceStringID(int row, int column) {
        if (!validCoords(row, column) || board[row][column] == null)
            return R.string.blank;
        else
            return (board[row][column] == Mark.X ? R.string.button_x : R.string.button_o);
    }
    ...
    public int getStatusStringID() {
        switch (status) {
            case IN_PROGRESS:
                return (turn == Mark.X ? R.string.status_x_turn : R.string.status_o_turn);
            case X_WIN:
                return R.string.status_x_win;
            case O_WIN:
                return R.string.status_o_win;
            case DRAW:
                return R.string.status_draw;
            default:
