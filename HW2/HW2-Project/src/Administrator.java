...
public class Administrator extends SalariedEmployee
{
	...
	{
		if (area == null)
			throw new NullPointerException("Area of Responsibility cannot be null.");
		else if (area.equals(""))
			throw new IllegalArgumentException("Area of Responsibility cannot be blank.");
		else
			this.area = area;
	}
	...
	public void setSupervisorsName(String supervisorsName)
	{
		if (supervisorsName == null)
			throw new NullPointerException("Supervisor's Name cannot be null.");
		else if (supervisorsName.equals(""))
			throw new IllegalArgumentException("Supervisor's Name cannot be blank.");
		else
