...
public class Team
{
	...
	* @param otherTeam The other team to deep-copy.
	* @throws NullPointerException if <b>otherTeam</b> is null.
 	*/
 	public Team(Team otherTeam)
 	{
		...
		//=============================//
 		...
 		// Verify that the method is not being passed a null.
 		if (otherTeam == null)
 			throw new NullPointerException();
 		
 		// Copy the basic fields from the other Team object.
 		this.teamName = otherTeam.getTeamName();
 		this.name1 = otherTeam.getName1();
 		this.name2 = otherTeam.getName2();
 		this.name3 = otherTeam.getName3();
 		this.name4 = otherTeam.getName4();
 		
 		// Deep copy the Competition objects.
 		Competition tempComp = otherTeam.getCompetition1();
 		this.competition1 = new Competition(
 				tempComp.getCompetitionName(),
 				tempComp.getWinner(),
 				tempComp.getRunnerup(),
 				tempComp.getYear());
 		tempComp = otherTeam.getCompetition2();
  ...
  public static void main(String[] args)
   	{
		...
		team2.setTeamName("Hellow World");
